...
### Current version: 0.33.0 ( 03.11.2018 18:44 MSK ) ALFA!!! PLEASE DO NOT INSTALL!!!!!
### Текущая версия:  0.33.0 ( 03.11.2018 18:44 MSK ) АЛЬФА!!! НЕ СТАВЬТЕ!!!
...
### 0. Выйдите из настроек инстанции, запустившихся автоматически после создания инстанции, без сохранения.
### 1. Включите инстанцию.
### 2. Подождите пару минут. За это время драйвер создаст все необходимые объекты на сервере и присвоит им дефолтные значения.
### 3. Перезапустите инстанцию, чтобы пересчитать настройки. 
### 4. Зайдите в настройки инстанции.
### 5. Задайте ip-адрес Меги (по умолчанию 192.168.0.14) и пароль (sec). 
###    Проверьте, что периодичность опроса установлена 60 секунд.  
###    При необходимости измените порт сервера (IoBroker веб-порт) и ip-адрес шлюза и сервера (эти адреса будут сохранены в Мегу).
###    Укажите тип подключенных исполнительных модулей.
### 6. Сохраните настройки. 
### 7. Считайте все настройки с Меги, при необходимости - поправьте их (см.пункт 5) .
