...
### Current version: 0.33.1 ( 03.11.2018 20:05 MSK ) ALFA!!! PLEASE DO NOT INSTALL!!!!!
### Текущая версия:  0.33.1 ( 03.11.2018 20:05 MSK ) АЛЬФА!!! НЕ СТАВЬТЕ!!!
...
### При создании новой инстанции:
### 1. В разделе "Драйвера" выберите драйвер MEGADJT и нажмите "Установить драйвер"
...
###    Нажмите кнопку запуска инстанции. Индикатор инстанции загорится красным, затем желтым, а кнопка запуска - зеленым и прервтаится в кнопку ПАУЗА.
### 5. Подождите пару минут. За это время драйвер создаст все необходимые объекты на сервере и присвоит им дефолтные значения.
...
###    Индикатор инстанции загорится красным, затем желтым. Обратите внимание - инстанция в этот момент настроена 
###    на IP-адрес по умолчанию (192.168.0.14), поэтому желательно не иметь в сети такого узла, иначе могут возникнуть проблемы.
### 8. Нажмите кнопку "Настроить" на нужной инстанции (кнопка с гаечным ключом). Откроется диалог настроек.
...
###       Если необходимо (например этот порт занят другими сервисами) - задайте свои значения.
###     - MegaD пароль. По умолчанию sec
...
###   при необходимости - поправьте настройки (см.пункт 9) .
### 8. Сохраните настройки
### 9. Донастройте порты (задайте комнату/функции)
### 10. сохраните настройки
### 11. при необходимости настройте у нужных параметров сохранение истории
