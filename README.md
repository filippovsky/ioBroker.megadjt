...
### Current version: 0.33.2 ( 03.11.2018 21:05 MSK ) ALFA!!! PLEASE DO NOT INSTALL!!!!!
### Текущая версия:  0.33.2 ( 03.11.2018 21:05 MSK ) АЛЬФА!!! НЕ СТАВЬТЕ!!!
...
###    Нажмите кнопку запуска инстанции. Индикатор инстанции загорится красным, затем желтым, а кнопка запуска - зеленым и превратится в кнопку ПАУЗА.
...
###    Индикатор инстанции загорится красным, затем желтым. Обратите внимание - инстанция в этот момент уже настроена 
...
###     Дождитесь окончания считывания.
### 13. Проверьте настройки Меги, которые вводились в пункте 9. 
###     При необходимости поправьте их, для чего:
